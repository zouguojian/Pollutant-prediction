...
from spatial_temporal_attention.hyparameter import parameter
from spatial_temporal_attention.encoder import s_lstm
...
class Model(object):
    ...
    def model(self):
        ...
        # cnn时空特征提取
        l = s_lstm(batch_size=self.para.batch_size,
