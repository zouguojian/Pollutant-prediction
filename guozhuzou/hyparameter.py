...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/', help='save path')
        ...
        self.parser.add_argument('--site_num', type=int, default=1, help='total number of city')

        self.parser.add_argument('--h', type=int, default=3, help='filter high')
        self.parser.add_argument('--w', type=int, default=3, help='filter wide')
        self.parser.add_argument('--features', type=int, default=7, help='numbers of the feature1')
        self.parser.add_argument('--normalize', type=bool, default=True, help='normalize')
        self.parser.add_argument('--input_length', type=int, default=72, help='input length')
