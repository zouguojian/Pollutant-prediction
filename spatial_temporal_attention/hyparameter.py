...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--pollutant_id', type=str, default='AQI', help='pollutant name')
        ...
        self.parser.add_argument('--input_length', type=int, default=120, help='input length')
        self.parser.add_argument('--output_length', type=int, default=120, help='output length')
